...
def output_pysent_pe_csv(year, team):
    ...
    # Select rows that are neutral and negative
    team_df = team_df[team_df["label"] != "NEG"]
    ...
    save_down_dir = r"C:\Users\clark\OneDrive - University of Warwick\Diss\2. Analysis\Data\pysent_scores_no_negatives"
